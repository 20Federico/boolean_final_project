                    ...
                    <form action=" {{ route('admin.apartments.store') }} " method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6 d-flex align-items-center">
                                <div class="form-check me-3">
                                    <input class="form-check-input @error('shared') is-invalid @enderror" type="radio" name="shared" id="flexRadioDefault1" value="1" @if(old('shared')==1) checked @endif>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6 d-flex align-items-center">
                                ...
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" name="visible" id="flexRadioDefault1" value="1" @if(old('visible')==1) checked @endif >
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Visible
                                    </label>
                                </div>
