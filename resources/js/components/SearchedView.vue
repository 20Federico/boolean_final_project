            ...
            <div class="col-12 col-xl-6">
                <div class="p-4">
                    ...
                    <div v-if="!filteredApartments">
                        ...
                        <p>
                            Prova a modificare la tua ricerca rimuovendo filtri
                            o ampliando l'area nella mappa
                        </p>
                    </div>
                    ...
                    >
                        <div class="row flex-column flex-md-row g-0">
                            <div class="col-md-4 card_img_box">
                                <img
                                    v-if="
                                        apartment['cover_img'].substr(0, 4) ===
                                        'http'
                                    "
                                ...
                                />
                                <span
                                    v-if="apartment.sponsor.length > 0"
...
export default {
    ...
    methods: {
        ...
        triggerWindow() {
            ...
            window.addEventListener("map", resizeHandler);
